(function($){
  ...
  //========== 函式庫 ==========
    ...
    function flipCard(){
      ...
      $('.card').off('dblclick touch')        //關閉所有卡牌點擊
    ...
    function openedHandler(){
      ...
      $('.card').not('.open').one('dblclick touch',flipCard)
    }
    ...
    function reset(){
      ...
      .children().removeClass('open').one('dblclick touch',flipCard)  // 給予點擊功能
      sort()                                                          // 打亂
      flip_time()                                                     // 開啟計時器
    }
  ...
  //========== 事件綁定 ==========
    ...
    //---卡牌點擊 === 防小人，已挪走
    // $('.card').one('dblclick touch',flipCard)
